        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background: #4a4e6b;">
                    <h5 class="modal-title text-uppercase text-white" id="exampleModalLabel">Add User</h5>
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="input-group">
                                        <input type="text" placeholder="name" name="name"  class="form-control" placeholder="Enter User  Name" />
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <label>Email</label>
                                    <div class="input-group">
                                        <input type="email" placeholder="Email" name="email" id="email"  class="form-control" placeholder="Enter User  Name" />
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <span class="form-text text-muted">Please Enter you Content Type</span>
                                        </div>
                    ...
                    <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
                        ...
                        @foreach($users as $user)
                            <tr>
                                ...
                                <td><a href="#" onclick="editcomp({{$user->id}})" data-id="{{$user->id}}" data-toggle="modal" data-target="#editCompany"><i class="fa fa-edit"></i></a></td>

                                <td><form action="{{ route('course.destroy',$user->id)}}" method="post">
                                        @csrf
                                        @method('DELETE')
