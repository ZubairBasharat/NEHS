        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-2 mr-5 text-uppercase">Toolbox Talk</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{url('toolbox-talk')}}"  class="text-muted">Back</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card-title w-100">
                        ...
                        <div class="row w-100">
                            <div class="form-group col-md-12">
                                <form  action="{{url('toolbox-store')}}" method="post">
                                    @csrf
                                    <input type="hidden" name="type" value="toolbox">
                                ...
                                <br>
                                <h3>Upload File</h3>
                                <form action="{{route('toolbox-store')}}" method="post" enctype="multipart/form-data">
                                    @csrf
