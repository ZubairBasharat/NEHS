                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <div class="input-group">
                                                                <select name="course_id" class="form-control" required>
                                                                    ...
                                                                    <option value="1">Safety Course</option>
                                                                    <option value="2">Security Course</option>
                                                                    <option value="3">Damage Control Course</option>
                                                                </select>
                                                            </div>
        ...
        <div class=" col-md-10 mx-auto d-block">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="text-dark mb-3" style="font-weight: 700">{{$video->video_title}}</p><br>
