        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-2 mr-5 text-uppercase">video-library-category</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{url('/video-library-category')}}" class="text-muted">Partner-library-category</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background: #4a4e6b;">
                    <h5 class="modal-title text-uppercase text-white" id="exampleModalLabel">Partner library Category</h5>
                ...
                <div class="modal-body p-0">
                    <div class="row">
                        <div class="col-12">
                            <form class="form" action="{{route('video-library-category.create')}}">
                                <div class="card-body">
...
{{--                                <td>{{$category->id}}</td>--}}
                                ...
                                <td><form action="{{ route('video-library-category.destroy',$category->id)}}" method="post">
                                        @csrf
                                        @method('DELETE')
...
@section('js')
    ...
    <script>
        ...
        function editcomp(id){
            ...
            var host = "{{url('video-library-category')}}"
            var id=parseInt(id);
            var url=host;
            var url2=host+'/'+id;
