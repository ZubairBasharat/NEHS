...
@section('dashboard')
    <div class="mb-3">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header" style="background: #4a4e6b;">
                            <h5 class="modal-title text-uppercase text-white" id="exampleModalLabel">Add New</h5>
                        ...
                        <div class="modal-body p-0">
                            <div class="row">
                                <div class="col-12">
                                    <form class="form" id="videoform" action="{{route('partnerlibrary.store')}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="card-body">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" name="video_title" required placeholder="Enter" class='form-control' id="videoTitle">
                                                    </div>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <select class="form-control" name="cat" required>
                                                            <option value="" disabled selected readonly>Select</option>
        ...
        <div class="container-fluid border border-0 border-info" style="background-color:#0e0e0e;">
            ...
            @foreach($categories as $categorie)
            <h1 style="margin-top:5px !important;color:white;">{{$categorie->name}}</h1>

            <div class="row">
                <div class="owl-carousel owl-theme">
                    @foreach ($videos as $video)
                        @if($video->cat_id == $categorie->id)
                        ...
                        <div class="items" >
                            <div class="card" style="">
                                @if($video->video_type=='2')
                                    <a href="{{$video->video}}" >
                                    @else
                                <a href="{{route('partnerlibrary.show',$video->id)}}" >
                                    @endif
                                    <img src="{{ URL::to('/') }}/assets/patnerlibrary/thumbnails/{{$video->thumbnail}}" style="height: 150px !important;width: 100%;" class="card-img">
                                </a>
                                        ...
                                        <div class="row justify-content-center align-items -center">
                                            ...
                                            <div class="col-6">
                                                <div class="d-flex justify-content-end align-items-center">
                                                        ...
                                                        <a href="{{route('partnerlibrary.edit',$video->id)}}" class="btn btn-sm d-block" ><i class="fa fa-edit text-white"></i></a >


                                                        <form action="{{ route('partnerlibrary.destroy',$video->id)}}" method="post" class="d-block">
                                                            @csrf
                                                            @method('DELETE')
