...
@section('subheader')
                                ...
                                <div class="card-body">
                                    ...
                                    <input type="hidden" name="edit-id" >
                                        ...
                                        <div class="col-12">
                                            <label for="CertificateName">Name</label>
                                            <div class="input-group">
                                                <input type="text" name="edit_name" placeholder="Canvasolution" class='form-control' id="edit_name" required>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <label for="CertificateName">Description</label>
                                            <div class="input-group">
                                                <input type="text" name="edit_descr"   class='form-control' id="edit_descr" required>
                                            </div>
                                        </div>
    ...
    <div class="modal fade w-100" id="add_remove_employee" data-backdrop="static"  tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl" role="document" id="fetch_data" style="margin-top:-180px !important;">
                        ...
                        <a href="#" class="btn btn-primary font-weight-bolder" data-toggle="modal" data-target="#addEquipment"  style="margin-right:10px !important; ">
                            ...
                            <a href="#" class="btn btn-primary font-weight-bolder" data-toggle="modal" data-target="#assignEquipment">
											<span class="svg-icon svg-icon-md">
                                                ...
                                                <!--end::Svg Icon-->
											</span>Assign Course to Groups</a>
                        <!--end::Button-->
