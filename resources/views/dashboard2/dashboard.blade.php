...
@section('menu-nav')
    ...
    <ul class="menu-nav">
        ...
        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
            <a href="{{url('/companies')}}" class="menu-link menu-toggle">
                <span class="svg-icon menu-icon">
...
@section('dashboard')
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-8">
                    <img src="{{URL::asset('/images/videolib2.jpg')}}" style="width:100%" class="img-fluid" />
                    <div class="col-md-12 overlay-text">
                        <h1 class="text-white gr-heading">LOCATION SAFETY REPORT</h1>
                        <p class="text-white">View pass Percentage perfomance Stats for the entire company or specific location</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <img src="{{URL::asset('/images/vid3.jpg')}}" style="width:100%; height:90%;" class="img-fluid" />
                    <div class="col-md-12 overlay-text">
                        <h1 class="text-white gr-heading">LOCATION SAFETY REPORT</h1>
                        <p class="text-white">View pass Percentage perfomance Stats for the entire company or specific location</p>
                    </div>
            ...
            <div class="row mt-3">
                <div class="col-md-4">
                    <img src="{{URL::asset('/images/videolib3.png')}}" style="width:100%" class="img-fluid" />
                    <div class="col-md-12 overlay-text">
                        <h1 class="text-white gr-heading">LOCATION SAFETY REPORT</h1>
                        <p class="text-white">View pass Percentage perfomance Stats for the entire company or specific location</p>
                    </div>
