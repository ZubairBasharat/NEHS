                        ...
                        <div class="col-12">
                            <form class="form" action="{{route('course.create')}}">
                                <div class="card-body">
                                    <div class="row">
                                       <div class="col-md-4" >
                                        <a href="{{url('admin/video-assignment')}}/{{$id}}"> <div class="mx-3" style="background: #4a4e6b; padding:20px; border-radius:10px;">
                                    ...
                                    <div class="col-md-4" >
                                        <a href="{{url('admin/file-assignment')}}/{{$id}}">  <div class="mx-3" style="background: #4a4e6b; padding:20px; border-radius:10px;">
                                        <h3 class="text-center text-white"><i class="fa fa-file"></i></h3>
                                        <p class="text-center text-light">Assignments</p>
                                        </div>
                                    </a>
                                </div>
                                <div class="col-md-4" >
                                  <a href="{{url('admin/question-assignment')}}/{{$id}}"> <div class="mx-3" style="background: #4a4e6b; padding:20px; border-radius:10px;">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body p-0">
                    <div class="row">
                        <div class="col-12">
                            <form class="form" id="videoform" action="{{url('admin/updateass')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped" id="">
                        ...
                        <tr>
                            ...
                            <th title="Field #2">Select</th>
                            <th title="Field #3">Questions</th>
                        ...
                        <tbody>
                            <form action="{{url('admin/add-q-assignment')}}" method="post" >
                                <input type="hidden" name="id" value="{{$id}}" />
                                @csrf
                            @foreach ($data as $data)
                            <tr>
                                <td>
                                <input type="checkbox"  name="questions[]" class="form-check" value="{{$data->id}}" />
                                </td>
                                <td>{{$data->question}}</td>
                            </tr>
                            ...
                            @endforeach
                            <input type="submit" name="submit" value="Add" class="btn btn-primary" /> </form>
