        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-2 mr-5 text-uppercase">Certificate Type</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{url('/certificatetype')}}" class="text-muted">Certificate Type</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body p-0">
                    <div class="row">
                        <div class="col-12">
                            <form class="form" action="{{route('certificatetype.create')}}">
                                <div class="card-body">
                                    <div class="form-group row">
                                        <div class="col-12">
                                            ...
                                            <span class="form-text text-muted">Please Enter Certificate Type</span>
                                        </div>
                        ...
                        <div class="dropdown dropdown-inline mr-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                ...
                                <ul class="navi flex-column navi-hover py-2">
                                    ...
                                    <li class="navi-item">
                                        <a href="{{route('Export_Record',['XLSX','certificates-type'])}}" class="navi-link">
                                    ...
                                    <li class="navi-item">
                                        <a href="{{route('Export_Record',['CSV','certificates-type'])}}" class="navi-link">
																<span class="navi-icon">
                                    ...
                                    <li class="navi-item">
                                        <a href="{{route('Export_Record',['pdf','certificates-type'])}}" class="navi-link">
																<span class="navi-icon">
                    ...
                    <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
                        ...
                        @foreach($types as $type)
                            <tr>
                                ...
                                <td><form action="{{ route('certificatetype.destroy',$type->id)}}" method="post">
                                        @csrf
                                        @method('DELETE')
