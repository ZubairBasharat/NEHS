            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    ...
                    <div class="card-toolbar container">
                        ...
                        <!--begin::Button-->
                        <div class="my-2">
                        <a href="#" class="btn btn-primary font-weight-bolder mx-2" data-toggle="modal" data-target="#invite">
                        ...
                        <div class="my-2">
                       <a href="#" class="btn btn-primary font-weight-bolder mx-2 " data-toggle="modal" data-target="#import">
                            <span class="svg-icon svg-icon-md">
                        ...
                        <!--begin::Button-->
                        <div class="my-2">
                        <a href="" class="btn btn-primary font-weight-bolder mx-2" data-toggle="modal" data-target="#assignCommon" >
                            <span class="svg-icon svg-icon-md">
                                <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Flatten.svg-->
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <!--begin::Button-->
                        <div class="my-2">
                        <a href="{{ route('file-export') }}" class="btn btn-primary font-weight-bolder mx-2">
                            <span class="svg-icon svg-icon-md">
                                <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Flatten.svg-->
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
...
{{--                                                        </div>--}}
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-8 col-form-label">
                                                                <div class="radio-inline">
                                                                    ...
                                                                    <label class="radio radio-solid">
                                                                        <input type="radio" name="type"  value="Temporary Labor"/> Temporary Labor
                                                                        <span></span>
                                                                    </label>
                                                                    <label class="radio radio-solid">
                        ...
                        <div class="modal fade w-100" id="import" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background: #4a4e6b;">
                        ...
                        <div class="col-12">
                            <form action="{{ route('file-import') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <label for="selectcourse">Choose(csv)</label>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body p-0">
                    <div class="row">
                        <div class="col-12">
                            <form class="form" action="{{url('admin/assign-common')}}" method="POST">
                                @csrf
                                <div class="card-body">
                                    <div class="form-group row">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-2">
                                                                ...
                                                                <div class="radio-inline">
                                                                    <label class="radio radio-solid">
                                                                        <input class="" type="radio" name="gender" id="edit-gender" checked value="1"  /> Male
                                                                        <span></span>
                                                                    </label>
                                                                    <label class="radio radio-solid">
...
{{--                                                                    <input type="text" name="job_no" id="edit-job_no" placeholder="Enter your Project Or Job Number " class="form-control">--}}
                                                            ...
                                                            <div class="col-lg-5">
                                                                ...
                                                                <div class="radio-inline">
                                                                    ...
                                                                    <label class="radio radio-solid">
                                                                        <input type="radio" name="type" id="edit-type" value="Temporary Labor"/> Temporary Labor
                                                                        <span></span>
                                                                    </label>
                                                                    <label class="radio radio-solid">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-12 py-2">
                                                <button type="reset" class="btn btn-secondary show-table-plan mx-1 my-1" >Training Plan</button>
                                                <button  type="reset" class="btn btn-outline-primary show-table-data mx-1 my-1 " data-sid='course'>Assign Courses</button>
                                                <button type="reset" class="btn btn-outline-primary show-table-data mx-1 my-1" data-sid='eq'>Certificates</button>
                                                <button id="user_groups" type="reset" class="btn btn-outline-primary show-table-data mx-1 my-1" data-sid='gr'>Groups / Classes</button>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
...
{{--                                <td>{{$work->job_no}}</td>--}}
                                ...
                                <td>@if($work->user->email_verified_at == null)
                                    invite was sent ({{$work->created_at}}) But has not yet used <a class="btn btn-secondary" href="{{route('worker.resend_mail',$work->id)}}">Resend</a></td>
                                    @endif
