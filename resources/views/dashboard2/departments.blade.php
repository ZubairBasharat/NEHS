        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-2 mr-5 text-uppercase">Departments</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{url('/department')}}" class="text-muted">Department</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background: #4a4e6b;">
                    <h5 class="modal-title text-uppercase text-white" id="exampleModalLabel">Department</h5>
                ...
                <div class="modal-body p-0">
                    <div class="row">
                        <div class="col-12">
                            <form class="form" action="{{route('department.create')}}">
                                <div class="card-body">
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <label for="companyName">Department Name</label>
                                            <div class="input-group">
                                                <input type="text" name="name" placeholder="Canvasolution" class='form-control' id="companyName" required>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group">
                                                <textarea name="description" id="description" cols="30" rows="10" class="form-control" style="resize:none;width:100%;" required></textarea>
                                            </div>
                                            <span class="form-text text-muted">Please Enter you Department description 1000/1500</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="dropdown dropdown-inline mr-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                ...
                                <ul class="navi flex-column navi-hover py-2">
                                    ...
                                    <li class="navi-item">
                                        <a href="{{route('Export_Record',['XLSX','department'])}}" class="navi-link">
                                    ...
                                    <li class="navi-item">
                                        <a href="{{route('Export_Record',['CSV','department'])}}" class="navi-link">
																<span class="navi-icon">
                                    ...
                                    <li class="navi-item">
                                        <a href="{{route('Export_Record',['pdf','department'])}}" class="navi-link">
																<span class="navi-icon">
                    ...
                    <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
                        ...
                        @foreach($companies as $companie)
                            <tr>
                                ...
                                <td><form action="{{ route('department.destroy',$companie->id)}}" method="post">
                                        @csrf
                                        @method('DELETE')
                                        @if(is_department_used($companie->id) > 0)
                                            <button type="button" disabled title="Unable To Delete Because In Used"><i class="fa fa-trash"></i></button>
                                            @else
