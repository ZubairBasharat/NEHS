        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-2 mr-5 text-uppercase">Projects</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{url('/projects')}}" class="text-muted">Projects</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background: #4a4e6b;">
                    <h5 class="modal-title text-uppercase text-white" id="exampleModalLabel">Enter Details</h5>
                ...
                <div class="modal-body p-0">
                    <div class="row">
                        <div class="col-12">
                            <form class="form" action="{{route('projects.create')}}">
                                <div class="card-body">
                                    <div class="form-group row">
                                        <div class="col-12">
                                            ...
                                            <span class="form-text text-muted">Please Enter Projects name</span>
                                        </div>
                        ...
                        <div class="dropdown dropdown-inline mr-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                ...
                                <ul class="navi flex-column navi-hover py-2">
                                    ...
                                    <li class="navi-item">
                                        <a href="{{route('Export_Record',['CSV','project'])}}" class="navi-link">
																<span class="navi-icon">
                ...
                <div class="card-body">
                    ...
                    <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
                        ...
                        <tr>
                            ...
                            <th title="Field #4">Created On</th>
                        ...
                        @foreach($types as $type)
                            <tr>
                                ...
                                <td><a class="btn btn-primary font-weight-bolder " onclick="editcomp({{$type->id}})" data-id="{{$type->id}}" data-toggle="modal" data-target="#editCompany"><i class="fa fa-edit"></i></a></td>

                                <td><form action="{{ route('projects.destroy',$type->id)}}" method="post">
                                        @csrf
                                        @method('DELETE')
                                        @if(is_proect_used($type->id) > 0)
