...
@section('menu-nav')
    ...
    <ul class="menu-nav">
        ...
        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
            <a href="{{url('/manager')}}" class="menu-link menu-toggle">
                <span class="svg-icon menu-icon">
        ...
        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
            <a href="{{url('/video-list')}}" class="menu-link menu-toggle">
                <span class="svg-icon menu-icon">
                ...
                <span class="menu-text">Video Catogory</span>

            </a>
        </li>
        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
            <a href="{{url('/video-category')}}" class="menu-link menu-toggle">
                <span class="svg-icon menu-icon">
        ...
        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
            <a href="{{url('/video-library')}}" class="menu-link menu-toggle">
                <span class="svg-icon menu-icon">
        ...
        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
            <a href="{{url('/certificates')}}" class="menu-link menu-toggle">
                <span class="svg-icon menu-icon">
                    <!--begin::Svg Icon | path:assets/media/svg/icons/General/Settings-1.svg-->
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <span class="menu-text">Ceritficates</span>
            </a>
        </li>
        ...
        <li class="menu-item menu-item-active" aria-haspopup="true" data-menu-toggle="hover">
            <a href="{{url('/video-category')}}" class="menu-link menu-toggle">
                ...
                <span class="menu-text">video-category</span>
            </a>
        </li>
        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
            <a href="javascript:;" class="menu-link menu-toggle">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-2 mr-5 text-uppercase">video-category</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{url('/video-category')}}" class="text-muted">Video-category</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background: #4a4e6b;">
                    <h5 class="modal-title text-uppercase text-white" id="exampleModalLabel">Video Category</h5>
                ...
                <div class="modal-body p-0">
                    <div class="row">
                        <div class="col-12">
                            <form class="form" action="{{route('video-category.create')}}">
                                <div class="card-body">
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <label for="companyName">video Category</label>
                                            <div class="input-group">
                                                <input type="text" name="name" placeholder="Canvasolution" class='form-control' id="companyName">
                                            </div>
                                            <span class="form-text text-muted">Please Enter your video Category</span>
                                        </div>
                                        <div class="col-12">
                                            <label for="description">Esp Name</label>
                                            <div class="input-group">
                                                <input type="text" name="esp_name" placeholder="Canvasolution" class='form-control' id="companyName">
                                            </div>
                                            <span class="form-text text-muted">Please Enter you Category Esp Name</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12">
                                            <label for="description">Esp Name</label>
                                            <div class="input-group">
                                                <input type="text" name="esp_name" id="esp-name" placeholder="Canvasolution" class='form-control'>
                                            </div>
                                            <span class="form-text text-muted">Please Enter you Company description 1000/1500</span>
                                        </div>
                                        <div class="col-12">
                    ...
                    <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
                        ...
                        @foreach($categories as $category)
                            <tr>
                                <td>{{$category->id}}</td>
                                <td>{{$category->name}}</td>
                                <td>{{$category->esp_name}}</td>
                                <td>{{$category->status}}</td>
                                <td >{{$category->created_at}}</td>
                                <td><a class="btn btn-primary font-weight-bolder " onclick="editcomp({{$category->id}})" data-id="{{$category->id}}" data-toggle="modal" data-target="#editCompany"><i class="fa fa-edit"></i></a></td>

                                <td><form action="{{ route('video-category.destroy',$category->id)}}" method="post">
                                        @csrf
                                        @method('DELETE')
...
@section('js')
    ...
    <script>
        ...
        function editcomp(id){
            ...
            // alert(id);
            var id=parseInt(id);
            var url="video-category";
            var url2="/video-category/"+id;
            $.ajax({
                type: "GET",
                url:   '/video-category/' + id + '/edit',
                data:{id:id},
                cache: false,
