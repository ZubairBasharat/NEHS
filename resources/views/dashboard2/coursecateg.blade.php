...
@section('menu-nav')
    ...
    <ul class="menu-nav">
        ...
        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
            <a href="{{url('/course-list')}}" class="menu-link menu-toggle">
                <span class="svg-icon menu-icon">
        ...
        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
            <a href="{{url('/course-category')}}" class="menu-link menu-toggle">
                <span class="svg-icon menu-icon">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-2 mr-5 text-uppercase">course-category</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{url('/course-category')}}" class="text-muted">course-category</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background: #4a4e6b;">
                    <h5 class="modal-title text-uppercase text-white" id="exampleModalLabel">Course Category</h5>
                ...
                <div class="modal-body p-0">
                    <div class="row">
                        <div class="col-12">
                            <form class="form" action="{{route('course-category.create')}}">
                                <div class="card-body">
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <label for="companyName">Course Category</label>
                                            <div class="input-group">
                                                <input type="text" name="name" placeholder="Canvasolution" class='form-control' id="companyName">
                                            </div>
                                            <span class="form-text text-muted">Please Enter your Course Category</span>
                                        </div>
                                        <div class="col-12">
                                            <label for="description">ESP Name</label>
                                            <div class="input-group">
                                                <input type="text" name="esp_name" placeholder="Canvasolution" class='form-control' id="esp-name">
                                            </div>
                                            <span class="form-text text-muted">Please Enter you Course Category in ESP</span>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="card-body">
                    ...
                    <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
                        ...
                        <tr>
                            ...
                            <td><form action="{{ route('course-category.destroy',$category->id)}}" method="post">
                                    @csrf
                                    @method('DELETE')
...
@section('js')
    ...
    <script>
       ...
       function editcomp(id){
           ...
           // alert(id);
        //   var id=parseInt(id);
        //   var url="course-category";
        //   var url2="/course-category/"+id;
        //   $.ajax({
        //       type: "GET",
        //       url:   '/course-category/' + id + '/edit',
        //       data:{id:id},
        //       cache: false,
               
               
               
                var host = "{{url('course-category')}}"
           var id=parseInt(id);
           var url=host;
           var url2=host+'/'+id;
           $.ajax({
