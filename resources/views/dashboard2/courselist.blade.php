                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="description" placeholder="English Description" class='form-control'  required>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="esp_name" placeholder="Spanish name" class='form-control'  required>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="esp_description" placeholder="Spanish Description" class='form-control'  required>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group">
                                                <select name="dep_id" class="form-control" required>
                                                    <option value="" disabled selected readonly>----Select Department----</option>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group">
                                                <select name="cat_id" class="form-control" required>
                                                    <option value="" disabled selected readonly>----Select Category----</option>
                        ...
                        <div class="col-12">
                            <form class="form"  method="post" action="" id="edit-form">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <label for="companyName">English Name</label>
                                            <div class="input-group">
                                                <input type="text" name="name" id="edit-name" placeholder="Canvasolution" class='form-control' id="companyName">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <label for="companyName">Eng Description</label>
                                            <div class="input-group">
                                                <input type="text" name="description" id="edit-eng_desc" placeholder="Canvasolution" class='form-control' id="companyName">
                                            </div>

                                        </div>
                                        <div class="col-12">
                                            <label for="companyName">Spanish Name</label>
                                            <div class="input-group">
                                                <input type="text" name="esp_name" id="edit-esp_name" placeholder="Canvasolution" class='form-control' id="companyName">
                                            </div>
                                        </div>

                                        <div class="col-12">
                                            <label for="companyName">Spanish Description</label>
                                            <div class="input-group">
                                                <input type="text" name="esp_description" id="edit-esp_desc" placeholder="Canvasolution" class='form-control' id="companyName">
                                            </div>
                        ...
                        <div class="dropdown dropdown-inline mr-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                ...
                                <ul class="navi flex-column navi-hover py-2">
                                    ...
                                    <li class="navi-item">
                                        <a href="{{route('Export_Record',['XLSX','courses'])}}" class="navi-link">
                                    ...
                                    <li class="navi-item">
                                        <a href="{{route('Export_Record',['CSV','courses'])}}" class="navi-link">
																<span class="navi-icon">
                                    ...
                                    <li class="navi-item">
                                        <a href="{{route('Export_Record',['pdf','courses'])}}" class="navi-link">
																<span class="navi-icon">
                ...
                <div class="card-body">
                    ...
                    <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
                        ...
                        <tr>
                            ...
                            <th title="Field #3">English</th>
                            <th title="Field #3">Spanish</th>
                        ...
                        @foreach($companies as $companie)
                            <tr>
                                ...
                                <td>{{count_course_assignments($companie->id)}} <a href="{{url('admin/course-assignment')}}/{{$companie->id}}/eng" class="btn @if(count_course_assignments($companie->id)==0) btn-warning @else btn-success @endif" >Add</a></td>
                                <td>{{count_esp_course_assignments($companie->id)}} <a href="{{url('admin/course-assignment')}}/{{$companie->id}}/esp" class="btn @if(count_esp_course_assignments($companie->id)==0) btn-warning @else btn-success @endif" >Add</a></td>
                                ...
                                <td><form action="{{ route('course.destroy',$companie->id)}}" method="post">
                                        @csrf
                                        @method('DELETE')
                                        @if(is_course_used($companie->id) > 0)
                                            <button type="button" disabled title="Unable To Delete"><i class="fa fa-trash"></i></button>
        ...
        function editcomp(id){
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    $('#edit-esp_name').val(data.esp_name);
                    $('#edit-eng_desc').val(data.description);
                    $('#edit-esp_desc').val(data.esp_description);
