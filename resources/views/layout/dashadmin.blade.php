						...
						<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
								...
								<ul class="menu-subnav">
									...
									<li class="menu-item menu-item-submenu {{request()->is('course')?'menu-item-active':''}}" aria-haspopup="true" data-menu-toggle="hover">
										...
										<span class="svg-icon menu-icon">
											...
											<span class="menu-text">Create A course</span>

										</a>
									</li>

                                    <li class="menu-item menu-item-submenu {{request()->is('group')?'menu-item-active':''}}" aria-haspopup="true" data-menu-toggle="hover">
                                        <a href="{{route('group')}}" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Shopping/Barcode-read.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            ...
                                            <span class="menu-text">Create A Group</span>
							...
							<span class="svg-icon menu-icon">
								...
								<!--end::Svg Icon-->
                                    ...
                                    <li class="menu-item menu-item-submenu {{request()->is('Ack-forms')?'menu-item-active':''}}" aria-haspopup="true" data-menu-toggle="hover">
                                        <a href="{{route('admin.ack-forms.index')}}" class="menu-link menu-toggle">
							<span class="svg-icon menu-icon">
								<!--begin::Svg Icon | path:assets/media/svg/icons/General/Settings-1.svg-->
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
									<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <!--end::Svg Icon-->
                                            ...
                                            <span class="menu-text">Acknowledgment Forms</span>
                                        </a>
                                    </li>
						...
						<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
							...
							<div class="menu-submenu" style="display: none; overflow: hidden;" kt-hidden-height="80">
								...
								<ul class="menu-subnav">
									...
									<li class="menu-item menu-item-submenu {{request()->is('course-category')?'menu-item-active':''}}" aria-haspopup="true" data-menu-toggle="hover">
										<a href="{{route('video-library-category.index')}}" class="menu-link menu-toggle">
								<span class="svg-icon menu-icon">
								<!--begin::Svg Icon | path:assets/media/svg/icons/Design/Bucket.svg-->
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
									<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								...
								<!--end::Svg Icon-->
											...
											<span class="menu-text">Partner Library Category</span>
										</a>
									</li>
		...
		<div class="offcanvas-wrapper mb-5 scroll-pull">
			...
			<div class="overlay rounded-lg mb-8 offcanvas-demo offcanvas-demo-active">
				...
				<div class="overlay-layer">
					...
					<a href="#" class="btn btn-light btn-shadow" target="_blank">RTL Version</a>
				</div>
			</div>
