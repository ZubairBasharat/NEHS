			...
			<div class="d-flex flex-row flex-column-fluid page">
                ...
                <span class="svg-icon menu-icon">
					...
					<!--end::Svg Icon-->
								...
								<li class="menu-item menu-item-submenu {{request()->is('certificates')?'menu-item-active':''}}" aria-haspopup="true" data-menu-toggle="hover">
                ...
                <span class="svg-icon menu-icon">
					...
					<!--end::Svg Icon-->
								...
								<li class="menu-item menu-item-submenu {{request()->is('question')?'menu-item-active':''}}" aria-haspopup="true" data-menu-toggle="hover">
									<a href="{{route('question.index')}}" class="menu-link menu-toggle">
                <span class="svg-icon menu-icon">
