...
@section('menu-nav')
    ...
    <ul class="menu-nav">
        <li class="menu-item menu-item-submenu" aria-haspopup="true">
            <a href="{{url('/dashboard1')}}" class="menu-link">
        ...
        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
            <a href="{{url('/course-statistics')}}" class="menu-link menu-toggle">
                <span class="svg-icon menu-icon">
        ...
        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
            <a href="{{url('/departments')}}" class="menu-link menu-toggle">
                <span class="svg-icon menu-icon">
        ...
        <li class="menu-item menu-item-active" aria-haspopup="true" data-menu-toggle="hover">
            <a target="_self" href="{{url('/group-class')}}" class="menu-link">
                <span class="svg-icon menu-icon">
        ...
        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
            <a href="{{url('/resources')}}" class="menu-link menu-toggle">
                <span class="svg-icon menu-icon">
