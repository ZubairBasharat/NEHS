            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{url('/user-forms')}}" class="text-muted">Forms</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body p-0">
                    <div class="row">
                        <div class="col-12">
                            <form class="form"  method="post" action="{{route('form.addto')}}" id="edit-form">
                                <div class="card-body">
                                    @csrf
                ...
                <div class="card-body">
                    ...
                    <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable2">
                        ...
                        <tr>
                            ...
                            <th title="Field #2">To Project</th>
                            <th title="Field #3">To Employee</th>
                                @endif
                        ...
                        @foreach($user_forms as $files)
                            {{--                                    @if($files->folder_id == 0)--}}
                            <tr>
                                <td><a href="{{route('um-resource.show',$files->forms->id)}}" >{{$files->forms->name}}</a></td>
                        ...
                        @else
                            ...
                            @foreach($file as $files)
                                @if(folder_byid($files->folder_id)->type == 'form')
                                    <tr>
                                        <td><a href="{{route('um-resource.show',$files->id)}}" >{{$files->name}}</a></td>
                                        <td>
                                            <a  class="btn btn-primary" data-toggle="modal" data-target="#assigntoproj" onclick="assign({{$files->form_id}})">Assign To Project</a>
                                        </td><td>
