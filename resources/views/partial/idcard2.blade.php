    ...
    <div class='card'>
        <div class="row justify-content-around align-items-center "  id="print2">
            <div class='col-xl-4 col-lg-4 col-sm-12 col-12 col-md-12 gg'>
                ...
                <div class="card border border-1 border-dark bg-warning">
                    <img src="{{asset('/')}}{{$user->photo}}" alt="photo" class="card-img" style="width:100%; height:270px; padding:50px;">
                    <div class="card-body" style="margin-top:-40px;">
                        ...
                        <div class="card-text">
                            <img style="height:230px !important;" src="{{asset('assets/media/logos/logo2.png')}}" alt="image-stamp" class="img-fluid rouned rounded-cricle d-block mx-auto w-75">
            ...
            <div class="col-xl-4 col-lg-4 col-sm-12 col-12 col-md-12">
                <div class='card bg-white border border-1 border-dark mt-xl-0 mt-lg-0 mt-md-4 mt-sm-4 mt-4 '>
                    ...
                    <div class='card-body'>
                        ...
                        <div class="card-title">
                            ...
                            <p class="text-center"><small>03206677036</small></p>
